...
--- @field name string Player name.
--- @field userid EntityIndex User ID on server (unique on server).
--- @field steamid Uint64 Player network (i.e steam) id.
...
--- @field attacker EntityIndex Player who attacked.
...
--- @field target1 EntityIndex Primary traget index.
--- @field target2 EntityIndex Secondary traget index or 0.
...
--- @field target EntityIndex Best/closest target entity.
...
--- @field fov number
--- @field target EntityIndex Follow this player.
...
--- @field attacker EntityIndex User ID who killed.
...
--- @field reliable integer This event is reliable.
...
--- @field player EntityIndex Entindex of the player.
...
--- @class dota2.events.bot_takeover
--- @field userid EntityIndex
--- @field botid EntityIndex
--- @field p number
--- @field y number
--- @field r number
...
--- @field SteamID Uint64

--- @class dota2.events.match_details_updated
--- @field matchID Uint64
...
--- @field playerid_victim PlayerID
...
--- @field published_file_id Uint64
...
--- @class dota2.events.dota_custom_camera_updated
--- @field flags integer DOTACustomCameraEventFlags_t.
--- @field zoom number
--- @field x number
--- @field y number
--- @field extra_yaw number
--- @field pitch number
--- @field duration number
--- @field player_id integer Only used if associated flag is set.

--- @class dota2.events.dota_event_game_camera_zoom_updated
--- @field zoom integer
--- @field duration number 0 - instantaneous camera update.

--- @class dota2.events.dota_event_game_camera_position_updated
--- @field x number
--- @field y number
--- @field duration number 0 - instantaneous camera update.

--- @class dota2.events.dota_custom_camera_pitch_updated
--- @field pitch number
...
--- @class dota2.events.dota_alchemist_granted_scepter
--- @field alchemist_userid EntityIndex
--- @field grantee_userid EntityIndex

--- @class dota2.events.dota_protector_spawned
--- @field player_id integer

--- @class dota2.events.dota_crafting_xp
--- @field userid EntityIndex
--- @field type integer
--- @field xp integer

--- @class dota2.events.dota_roshan_roar
--- @field teamnumber integer
...
--- @class dota2.events.dota_hero_on_gain_aggro
--- @field entindex_attacker EntityIndex
--- @field entindex_hero EntityIndex
