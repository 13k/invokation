...
<root>
  <scripts>
    <include src="file://{resources}/layout/custom_game/custom_ui_manifest.js" />
  </scripts>

  <Panel>
    <CustomUIElement type="HudTopBar" layoutfile="file://{resources}/components/top_bar.xml" />
    <CustomUIElement type="Hud" layoutfile="file://{resources}/components/combat_log.xml" />
    <CustomUIElement type="Hud" layoutfile="file://{resources}/components/picker.xml" />
    <CustomUIElement type="Hud" layoutfile="file://{resources}/components/viewer.xml" />
    <CustomUIElement type="Hud" layoutfile="file://{resources}/components/challenge.xml" />
    <CustomUIElement type="Hud" layoutfile="file://{resources}/components/freestyle.xml" />
  </Panel>
</root>
</layout>

<script lang="ts">
import { AbilitiesCollection } from "../../scripts/lib/abilities_collection";
import { CombosCollection } from "../../scripts/lib/combos_collection";
...
UI.config.combos = new CombosCollection();
UI.config.abilities = new AbilitiesCollection();

export default class CustomUIManifest extends Component {
  constructor() {
    super();
    ...
    UI.config.combos.load();
    UI.config.abilities.load();

    this.debug("init");
  }
}

global.customUIManifest = new CustomUIManifest();
</script>
