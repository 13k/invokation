...
export type AddStyle = [
    className: string
];

/**
 * Add a CSS class to a panel after a specified delay. */
export type AddStyleAfterDelay = [
    className: string,
    preDelay: number
];
...
export type DisplayDashboardTip = [
    string: string,
    optional: string
];
...
export type ExternalBrowserGoToURL = [
    url: string
];
...
export type HideCustomLayoutTooltip = [
    id: string
];
...
export type RemoveStyleAfterDelay = [
    className: string,
    preDelay: number
];
...
export type RemoveStyleFromEachChild = [
    className: string
];

/**
 * Fires an entity input within a DOTAScenelPanel. */
export type SceneFireEntityInput = [
    entityID: string,
    inputName: string,
    value: string
];
...
export type SetCarouselSelectedChild = [
    selectedPanel: Panel
];

/**
 * Set whether any child panels are :selected. */
export type SetChildPanelsSelected = [
    selected: boolean
];
...
export type SetPanelEnabled = [
    enabled: boolean
];

/**
 * Set whether this panel is :selected. */
export type SetPanelSelected = [
    selected: boolean
];

/**
 * Show tooltip for an item in the entityIndex NPC's inventory. */
export type ShowAbilityInventoryItemTooltip = [
    entityIndex: number,
...
export type ShowAbilityTooltip = [
    abilityName: string
];
...
export type ShowAbilityTooltipForEntityIndex = [
    abilityName: string,
    entityIndex: number
];
...
export type ShowAbilityTooltipForGuide = [
    abilityName: string,
    guideName: string
];
...
export type ShowAbilityTooltipForHero = [
    abilityName: string,
    heroid: number,
    arg3: boolean
];
...
export type ShowAbilityTooltipForLevel = [
    level: string,
    arg2: number
];
...
export type ShowCustomLayoutPopup = [
    id: string,
    layoutPath: string
];
...
export type ShowCustomLayoutPopupParameters = [
    id: string,
    layoutPath: string,
    parameters: string
];
...
export type ShowCustomLayoutTooltip = [
    id: string,
    layoutPath: string
];
...
export type ShowEconItemTooltip = [
    itemDef: number,
    styleIndex: number,
    heroId: number
];
...
export type ShowMatchDetails = [
    matchId: number
];

/**
 * Show the battle cup portion of the user's profile card, if it exists */
export type ShowProfileCardBattleCupTooltip = [
    steamId: number
];
...
export type ShowProfileCardTooltip = [
    steamId: number,
    useProName: boolean
];
...
export type ShowRankTierTooltip = [
    steamId: number,
    edotaPlayerMmrType: PlayerMMRType
];

/**
 * Show a rune tooltip in the X Y location for the rune type */
export type ShowRuneTooltip = [
    x: number,
    y: number,
    runeType: number
];
...
export type ShowTextTooltipStyled = [
    text: string,
    style: string
];
...
export type ShowTitleImageTextTooltip = [
    title: string,
    imagePath: string,
    text: string
];
...
export type ShowTitleTextTooltip = [
    title: string,
    text: string
];
 ...
 * Show a tooltip with the given title and text.
 * Also apply a CSS class named "style" to allow custom styling. */
export type ShowTitleTextTooltipStyled = [
    title: string,
    text: string,
    style: string
];
