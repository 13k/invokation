...
const { Component, CustomEvents, lodash: _ } = GameUI.CustomUIConfig();
...
class PopupTextEntry extends Component<Elements> {
  ...
  Submit() {
    ...
    this.sendClientSide(CustomEvents.Name.POPUP_TEXT_ENTRY_SUBMIT, payload);
    this.Close();
  }
}

// eslint-disable-next-line @typescript-eslint/no-unused-vars
const component = new PopupTextEntry();

export type { PopupTextEntry };
