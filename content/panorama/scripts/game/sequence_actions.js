// s2r://panorama/scripts/sequence_actions.vjs
...
(function(_global, context) {
  ...
  BaseAction.prototype.update = function() {
    return false;
  };
  ...
  context.RunSequentialActions = RunSequentialActions;
  context.RunParallelActions = RunParallelActions;
  context.RunStaggeredActions = RunStaggeredActions;
  context.RunUntilSingleActionFinishedAction = RunUntilSingleActionFinishedAction;
  context.RunFunctionAction = RunFunctionAction;
  context.WaitAction = WaitAction;
  context.WaitOneFrameAction = WaitOneFrameAction;
  context.WaitForEventAction = WaitForEventAction;
  context.ActionWithTimeout = ActionWithTimeout;
  context.PrintAction = PrintAction;
  context.AddClassAction = AddClassAction;
  context.RemoveClassAction = RemoveClassAction;
  context.SwitchClassAction = SwitchClassAction;
  context.WaitForClassAction = WaitForClassAction;
  context.SetDialogVariableIntAction = SetDialogVariableIntAction;
  context.AnimateDialogVariableIntAction = AnimateDialogVariableIntAction;
  context.SetProgressBarValueAction = SetProgressBarValueAction;
  context.AnimateProgressBarAction = AnimateProgressBarAction;
  context.AnimateProgressBarWithMiddleAction = AnimateProgressBarWithMiddleAction;
  context.PlaySoundEffectAction = PlaySoundEffectAction;
  context.RunSingleAction = RunSingleAction;
