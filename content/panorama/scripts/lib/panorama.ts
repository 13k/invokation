...
function createPanel<T extends Panel>(
  parent: Panel,
  id: string,
  layout: string,
  override = false,
...
function createPanelSnippet<T extends Panel>(parent: Panel, id: string, snippet: string): T {
  const panel = $.CreatePanel(PanelType.Panel, parent, id) as T;
...
function createAbilityImage(parent: Panel, id: string, abilityName: string): AbilityImage {
...
function createItemImage(parent: Panel, id: string, itemName: string): ItemImage {
...
function createAbilityOrItemImage(parent: Panel, id: string, abilityName: string) {
...
function serializeParams(params: SerializableParams): string {
...
export type Panorama = typeof module;

CustomUIConfig.Panorama = module;
