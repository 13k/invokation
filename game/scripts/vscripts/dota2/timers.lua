--[[--
  @module timers
  @author github/bmddota (original author)
  @author github/13k (updates, clean up, fixes, improvements)
  @license Apache 2.0 (http://www.apache.org/licenses/LICENSE-2.0)
  @copyright bmddota

  Original code: https://github.com/bmddota/barebones
]]
...
--[[--
  ...
  - `callback` (function) Timer function.
  - `context` (table) Context table to be passed to the callback. [default: `nil`]
  - `delay` (number|nil) Delay start time (seconds). `nil`, `0` or negative
    number means it starts immediately. [default: `0`]
  - `realtime` (bool) If true, uses real clock (ignores pauses). [default: `false`]
  - `onError` (function) Error handler function. If `nil`, uses a default
    error handling implementation. [default: `nil`]
