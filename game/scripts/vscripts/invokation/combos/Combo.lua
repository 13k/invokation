...
-- @tparam string spec.name Name
-- @tparam string spec.specialty Specialty
-- @tparam string spec.category Category
-- @tparam string spec.stance Stance
-- @tparam int spec.hero_level Recommended hero level
-- @tparam int spec.damage_rating Damage rating
-- @tparam int spec.difficulty_rating Difficulty rating
-- @tparam array(string) spec.items Required items
