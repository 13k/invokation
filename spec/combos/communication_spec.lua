...
describe("combos.communication", function()
  ...
  describe(".sendAbilityUsed", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBAT_LOG_ABILITY_USED,
        player,
        payload
      )
    end)
  ...
  describe(".sendStarted", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_STARTED,
        player,
        payload
      )
    end)
  ...
  describe(".sendStopped", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_STOPPED,
        player,
        payload
      )
    end)
  ...
  describe(".sendInProgress", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_IN_PROGRESS,
        player,
        payload
      )
    end)
  ...
  describe(".sendProgress", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_PROGRESS,
        player,
        payload
      )
    end)
  ...
  describe(".sendStepError", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_STEP_ERROR,
        player,
        payload
      )
    end)
  ...
  describe(".sendPreFinish", function()
    it("sends custom event", function()
      local abilityWithWait = create("ability", {
        name = "ability",
        AbilityDuration = 3.5,
      })
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_PRE_FINISH,
        player,
        payload
      )
    end)
  ...
  describe(".sendFinished", function()
    it("sends custom event", function()
      ...
      assert.spy(CustomEvents.SendPlayer).was.called_with(
        CustomEvents.EVENT_COMBO_FINISHED,
        player,
        payload
      )
    end)
